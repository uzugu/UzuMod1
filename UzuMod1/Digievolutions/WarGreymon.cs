...
namespace ExampleSurvivor.Digievolutions
{
    ...
    public class WarGreymon : MonoBehaviour
    {
        ...
        static void PrimarySetup()
        {
            ...
            mySkillDef.activationState = new SerializableEntityStateType(typeof(WarSlash2));
    ...
    namespace EntityStates.ExampleSurvivorStates
    {
        ...
        public class GreatTornado : BaseState
        {
            ...
            private void FireArrow()
            {

                {
                    ...
                    base.PlayAnimation("FuegoW", "WarSpin");
            ...
            public override void OnEnter()
            {
                ...
                {
                   // base.PlayAnimation("FuegoW", "WarSpinDash", "FireArrow.playbackRate", 0.5f * this.duration);
                    FireArrow();
        ...
        public class WarCharge : BaseState
        {
            ...
            public override void OnEnter()
            {
                ...
                base.PlayAnimation("FuegoW", "WarSpindash");
            ...
            private void ResetOverlapAttack()
            {
                ...
                if (!this.hitboxGroup)
                {
                    ...
                    if (modelTransform)
                    {
                        this.hitboxGroup = Array.Find<HitBoxGroup>(modelTransform.GetComponents<HitBoxGroup>(), (HitBoxGroup element) => element.groupName == "HeadWCh");
                    }
                }
        ...
        public class WarSlash : BaseSkillState
        {
            ...
            public override void OnEnter()
            {
                ...
                this.earlyExitDuration = this.duration * WarSlash.earlyExitTime;
                this.hasFired = false;
                ...
                Transform modelTransform = base.GetModelTransform();
                base.PlayAnimation("Atacc", "WarAttack1");
                if (modelTransform)
                {
                    hitBoxGroup = Array.Find<HitBoxGroup>(modelTransform.GetComponents<HitBoxGroup>(), (HitBoxGroup element) => element.groupName == "HeadWCh");
                }
                ...
                string animString = "WarAttack" + (1 + swingIndex).ToString();

                if (this.inCombo)
                {
                    if (!this.animator.GetBool("isMoving") && this.animator.GetBool("isGrounded")) base.PlayCrossfade("Atacc", "WarAttack", "WarSlash.playbackRate", this.duration, 0.05f);
                    base.PlayCrossfade("Atacc", "SlashCombo1", "WarSlash.playbackRate", this.duration, 0.05f);
                }
                else
                {
                    if (!this.animator.GetBool("isMoving") && this.animator.GetBool("isGrounded")) base.PlayCrossfade("Atacc", animString, "WarSlash.playbackRate", this.duration, 0.05f);
                    base.PlayCrossfade("Atacc", animString, "WarSlash.playbackRate", this.duration, 0.05f);
                }

                float dmg = WarSlash.damageCoefficient;
                    ...
                    if (base.isAuthority)
                    {
                        ...
                        if (this.attack.Fire())
                        {
                            ...
                            if (!this.hasHopped)
                            {
                                ...
                                {
                                    base.SmallHop(base.characterMotor, WarSlash.hitHopVelocity);
                                }
                            ...
                            if (!this.inHitPause)
                            {
                                this.hitStopCachedState = base.CreateHitStopCachedState(base.characterMotor, this.animator, "WarSlash.playbackRate");
            ...
            public override void FixedUpdate()
            {
                ...
                else
                {
                    ...
                    if (this.animator) this.animator.SetFloat("WarSlash.playbackRate", 0f);
                }
        ...
        public class WarSlash2 : BaseSkillState
        {
            ...
            public override void OnEnter()
            {
                ...
                if (modelTransform)
                {
                    hitBoxGroup = Array.Find<HitBoxGroup>(modelTransform.GetComponents<HitBoxGroup>(), (HitBoxGroup element) => element.groupName == "HeadW");
                }
                ...
                if (this.inCombo)
                {
                    if (!this.animator.GetBool("isMoving") && this.animator.GetBool("isGrounded")) base.PlayCrossfade("Atacc", "WarAttack1", "WarSlash2.playbackRate", this.duration, 0.05f);
                    base.PlayCrossfade("Attac", "WarAttack1", "Slash.playbackRate", this.duration, 0.05f);
                }
                else
                {
                    if (!this.animator.GetBool("isMoving") && this.animator.GetBool("isGrounded")) base.PlayCrossfade("Atacc", animString, "WarSlash2.playbackRate", this.duration, 0.05f);
                    base.PlayCrossfade("Atacc", animString, "WarSlash2.playbackRate", this.duration, 0.05f);
                }

                float dmg = WarSlash2.damageCoefficient;
            ...
            public void FireAttack()
            {
                if (!this.hasFired)
                {
                    ...
                    if (base.isAuthority)
                    {
                        ...
                        //base.AddRecoil(-1f * WarSlash2.attackRecoil, -2f * WarSlash2.attackRecoil, -0.5f * WarSlash2.attackRecoil, 0.5f * WarSlash2.attackRecoil);
                        //EffectManager.SimpleMuzzleFlash(this.swordController.swingEffect, base.gameObject, muzzleString, true);
                        ...
                        Ray aimRay = base.GetAimRay();
                           ...
                           //it works// ProjectileManager.instance.FireProjectile(WarGreymon.GreymonBlast, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), base.gameObject, 2f * this.damageStat, 0f, Util.CheckRoll(this.critStat, base.characterBody.master), DamageColorIndex.WeakPoint, null, 2f);
